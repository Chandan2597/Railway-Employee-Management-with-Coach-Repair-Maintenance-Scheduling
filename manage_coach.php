		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Coach</span></a>
					</div>
				</div>
			</div>
			<?php
			...
			<table class="table table-striped table-hover">
				...
				<?php
					...
					$sql="SELECT * FROM coach LIMIT {$offset},{$limit}";
					...
					while($row=$result->fetch_assoc()){
						...
						<td>
							<a href='edit_coach_form.php?id=<?php echo $row['coachid']; ?>' class='btn btn-info text-white'>Edit</a>
						</td>
						<td>
							<input type="hidden" class="delete_id_value" value="<?php echo $row['coachid']; ?>">
			...
			if(mysqli_num_rows($result1) > 0){
				...
				<ul class="pagination">';
				if($page > 1){
					echo '<li ><a href="manage_coach.php?page='.($page - 1).'">Previous</a></li>';
				}
				for($i=1; $i<= $total_page; $i++){
					...
					echo'<li class="page-item '.$active.'"><a href="manage_coach.php?page='.$i.'" class="page-link">'.$i.'</a></li>';
				}
				if($total_page > $page){
					echo '<li ><a href="manage_coach.php?page='.($page + 1).'">Next</a></li>';
				}
				echo'</ul>
				</div>';
			}
			...
			<form action="add_coach.php" method="post">
				...
				<div class="modal-body">					
					<div class="form-group">
						...
						<input type="number" class="form-control" name="coachid" required>
					</div>
					<div class="form-group">
						<label>Coach Type</label>
						<input type="text" class="form-control" name="coachtype" required>
					</div>
					<div class="form-group">
